function [ bh_fitness,T ] = Copy_of_CBH_7( fhd, D, pop_size, iter_max, popmin, popmax, func_num )
%CBH_7 此处显示有关此函数的摘要
%   这是真正的CBH文件
%%初始化参数
c = 2.0;
...
%每个粒子迭代5000次
for i=1:4
    [bh_sub_fit, T_sub, bh_R_sub, bh_sub] = Copy_of_worker(bh, pop(i,:), pop_size, mu, sicma, bh_R_sub, fhd, D, sub_iter_max, popmin+(i-1)*50, popmin+i*50,func_num);
