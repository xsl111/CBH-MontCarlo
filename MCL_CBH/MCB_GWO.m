...
% Grey Wolf Optimizer
function Alpha_pos = MCB_GWO(dim,SearchAgents_no,Max_iter,Xpos,Ypos,RXpos,RYpos,newSeed,SeedNo,BorderLength)
% Pos_GWO = MCB_GWO(D,pop_size,iter_max,X,Y,newUNNode(1,i),newUNNode(2,i),newSeed,SeedNo);
Xmin = Xpos - 10;
Xmax = Xpos + 10;
Ymin = Ypos - 10;
Ymax = Ypos + 10;
...
Positions=initialization(SearchAgents_no,dim,Xpos,Ypos);
